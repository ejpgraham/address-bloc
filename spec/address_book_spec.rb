...
RSpec.describe AddressBook do
  ...
  describe "remove_entry" do
    it "removes only one entry from the address book" do
      book.add_entry('Ada Lovelace', '010.012.1815', 'augusta.king@lovelace.com')
      book.add_entry('Shelly Duval', '211.011.5555', 'hellothere@goodbye.com')
  ...
  describe "#import_from_csv" do
    ...
    describe "entries_2" do

      it "imports the 1st entry from entries_2" do
        book.import_from_csv("entries_2.csv")
        entry_one = book.entries[0]
        check_entry(entry_one, "Hamish","555-565-3360","hamish@blocmail.com" )
      end

      it "imports the 2nd entry from entries_2" do
        book.import_from_csv("entries_2.csv")
        entry_two = book.entries[1]
        check_entry(entry_two, "Shelly","555-511-5215","shelly@blocmail.com")
      end

      it "imports the 3rd entry from entries_2" do
        book.import_from_csv("entries_2.csv")
        entry_three = book.entries[2]
        check_entry(entry_three, "Thomas","555-123-4854","thomas@blocmail.com")
      end
    end
